...
//        n::bind(&f_2); // shouldn't compile-------not ok
//        n::bind(&f_2, 1); // shouldn't compile--------not ok
        assert(n::bind(&f_2, 1, 2)() == 21);
        assert(n::bind(&f_2, 1, 2)(c) == 21);
        assert(n::bind(&f_2, 1, 2)(c, 6.0) == 21);
//        assert(n::bind(&f_2, 1, _1)() == 21); // shouldn't compile -----ok
...
//        n::bind(&f_2, _1, _2)(1); // shouldn't compile-----ok(check)
        assert(n::bind(&f_2, _1, _2)(1, 2) == 21);
        assert(n::bind(&f_2, _2, _1)(1, 2) == 12);
        //n::bind(&f_2, _1, _1)(); // shouldn't compile------ok(check)
